...
public class SftpclientSanityTest extends SystemTestCase4 {
	...
	public void connectBntccServer() throws Exception {
		report.report("connectBntccServer " + mySftpclient.getTftpServer());
	...
	public void disconnectServer() throws Exception {
		report.report("connectServer " + mySftpclient.getTftpServer());
		mySftpclient.disconnect();
	}
	
	@Test
	public void DownImage() throws Exception {
		report.report("ftpDown " + mySftpclient.getTftpServer());
	...
	@Test
	public void DownDirectory() throws Exception {
		report.report("ftpDown " + mySftpclient.getTftpServer());
		mySftpclient.downloadDirectory(mySftpclient.getTftpRoot(),  mySftpclient.getLocalPath());
	}
	
	@Test
	public void UpDirectory() throws Exception {
		report.report("ftpUp" + mySftpclient.getTftpServer());
		mySftpclient.uploadDirectory(mySftpclient.getTftpRoot(),  mySftpclient.getLocalPath());
	}
}
