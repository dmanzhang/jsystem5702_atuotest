...
public class HostSanityTest extends SystemTestCase4 {
	...
	@Test
	public void buildBundleFCStkc() throws Exception {
		report.report("BundleFC");
		myStation.rawCommandNoTimeOut("buildbert -bundle_only -hw HW_GRYPHON_FC_STKC -hw HW_EAGLE_STKC", "bert ]");
		myStation.analyze(new FindText("Bundle build - Final Bundling"));
	}
